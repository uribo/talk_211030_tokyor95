...
if (file.exists("data-raw/2015_mi040001.csv") == FALSE) {
...
list(
  ...
  tar_target(
    df_pops_raw,
    readr::read_csv("data-raw/2015_mi040001.csv", 
                    skip = 10,
                    na = "\u3000\u3000\u3000\u3000\u3000 \u2026",
                    col_types = c("c",
  ...
  # 3. データ加工1: データの列名を変更し、特定の列への処理を加える
  tar_target(
    df_pops_mod,
    df_pops_raw %>% 
